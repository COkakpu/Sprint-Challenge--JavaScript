...
const unisWithUni = grduates.filter(function(element){
  if(element.university === ' University') {
    return element;
  }
...
const displayNames = zooAnimals.forEach(function (element) {
  console.log(
    "name: " +
      element.animal_name +
      " scientific: " +
...
*/
const populationTotal =zooAnimals.reduce(function(total,item){
